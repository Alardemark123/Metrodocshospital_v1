...
export const metadata: Metadata = {
  title: "Home",
  description: "metrodocshospital delivers compassionate care with trusted medical professionals. Find doctors, explore departments, and access quality healthcare.",
}
