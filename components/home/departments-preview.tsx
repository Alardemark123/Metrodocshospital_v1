...
const departments = [
  {
    ...
    description: "24/7 emergency care with rapid response teams ready to handle any medical crisis.",
  ...
  },
  {
    icon: ScanLine,
    name: "Radiology",
    description: "Advanced imaging services including MRI, CT scans, X-rays, and ultrasound.",
  ...
  },
  {
    ...
    description: "Expert diagnosis and treatment of adult diseases and chronic conditions.",
